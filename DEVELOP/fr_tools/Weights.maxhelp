...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 763.0, 194.0, 50.0, 22.0 ],
					"text" : "8 2 2 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 758.0, 120.0, 42.0, 22.0 ],
					"text" : "4 4 8n"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 947.0, 125.0, 79.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 758.0, 148.0, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 786.0, 321.0, 29.5, 22.0 ],
					"text" : "0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 518.0, 396.0, 351.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 786.0, 362.0, 80.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "11 0 6 2 8 4 10 1 7 3 9 5",
					"textcolor" : [ 0.952941, 0.564706, 0.098039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Compute Sioros (2011) weights from Clarence Barlow Indispensability values which are originated from the prime factors of a given meter.",
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 2 ],
					"midpoints" : [ 453.5, 225.56640625, 856.5, 225.56640625 ],
					"order" : 0,
					"source" : [ "obj-23", 0 ]
				}
