...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 284.5, 427.0, 397.0, 20.0 ],
					"text" : "loadmess \"perpetrator_edition::added feature to fill up menu with triplets\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 284.5, 462.0, 91.0, 20.0 ],
					"text" : "print kin.stratify"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 127.0, 143.0, 196.0, 46.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/diogococharro/Dropbox/Private Box/Tese box/_PATCHES/_Release/kineticToolboxV1.0/Kinetic_abstractions",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
