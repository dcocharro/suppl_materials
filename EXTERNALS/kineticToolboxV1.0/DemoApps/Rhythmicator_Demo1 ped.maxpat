...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 99.0, 460.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 561.0, 198.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 459.0, 319.0, 151.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 590.0, 135.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 642.0, 148.0, 62.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 16.0, 287.0, 348.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 15.0, 325.0, 346.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 69.0, 641.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 667.5625, 267.0, 152.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 127.0, 810.0, 76.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 198.5625, 567.0, 64.0, 20.0 ],
					"text" : "MIDI OUT"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					"name" : "kin.rhythmicator ped.maxpat",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 252.5625, 384.0, 351.4375, 176.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.5625, 105.0, 332.0, 178.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1::obj-132" : [ "morph", "morph", 0 ],
			"obj-1::obj-103" : [ "user pattern", "pattern", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "kin.rhythmicator ped.maxpat",
				"bootpath" : "/Users/diogococharro/Dropbox/Private Box/Tese box/_PATCHES/_Release/kineticToolboxV1.0/Kinetic_Modules",
				"patcherrelativepath" : "../Kinetic_Modules",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../Kinetic_abstractions",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
