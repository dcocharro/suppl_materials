...
,
		"rect" : [ 956.0, 221.0, 465.0, 566.0 ],
		"bglocked" : 0,
		"defrect" : [ 956.0, 221.0, 465.0, 566.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 520.0, 167.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"id" : "obj-5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 440.0, 19.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"id" : "obj-25",
					"patcher" : 					{
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 50.0, 134.0, 59.5, 20.0 ],
									"fontsize" : 12.0,
									"numinlets" : 1,
									"id" : "obj-6",
									"coll_data" : 									{
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 215.0, 76.0, 20.0 ],
									"fontsize" : 12.0,
									"numinlets" : 1,
									"id" : "obj-28"
								}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 0,
					"patching_rect" : [ 108.0, 473.0, 144.0, 25.0 ],
					"fontface" : 1,
					"fontsize" : 16.0,
					"numinlets" : 1,
					"id" : "obj-30"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 161.0, 414.0, 91.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"id" : "obj-27"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "kin.ReduceChord",
					"fontname" : "Arial",
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 108.0, 384.0, 144.0, 25.0 ],
					"fontface" : 1,
					"fontsize" : 16.0,
					"numinlets" : 1,
					"id" : "obj-26"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 351.0, 45.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"id" : "obj-22"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 105.0, 292.0, 32.5, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"id" : "obj-19"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 108.0, 321.0, 57.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"id" : "obj-16"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "kin.reducechord sorts lists of midi notes according to their level of dissonance as understood in tonal music. The algorithm follows the implementation by Rowe described in Machine Musicianship, The MIT Press, 2001.",
					"linecount" : 3,
					"fontname" : "Arial",
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 94.0, 440.0, 48.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"id" : "obj-3"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "reduces the input chord into pitch classes and determines its root and type",
					"fontname" : "Arial",
					"numoutlets" : 0,
